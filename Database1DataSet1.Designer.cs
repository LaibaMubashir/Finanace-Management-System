...
namespace Finance {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(int id, string name, string username, string password, string department, string phone_number) {
...
namespace Finance.Database1DataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([id], [name], [username], [password], [department], [phone_number]) VALUES (@id, @name, @username, @password, @department, @phone_number);
SELECT id, name, username, password, department, phone_number FROM Users WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [id] = @id, [name] = @name, [username] = @username, [password] = @password, [department] = @department, [phone_number] = @phone_number WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_department = 1 AND [department] IS NULL) OR ([department] = @Original_department)) AND ((@IsNull_phone_number = 1 AND [phone_number] IS NULL) OR ([phone_number] = @Original_phone_number)));
SELECT id, name, username, password, department, phone_number FROM Users WHERE (id = @id)";
        ...
        public virtual int Insert(int id, string name, string username, string password, string department, string phone_number) {
        ...
        public virtual int Update(int id, string name, string username, string password, string department, string phone_number, int Original_id, string Original_name, string Original_username, string Original_password, string Original_department, string Original_phone_number) {
        ...
        public virtual int Update(string name, string username, string password, string department, string phone_number, int Original_id, string Original_name, string Original_username, string Original_password, string Original_department, string Original_phone_number) {
            return this.Update(Original_id, name, username, password, department, phone_number, Original_id, Original_name, Original_username, Original_password, Original_department, Original_phone_number);
        }
    }
