...
namespace Finance {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string name, string username, string password, string department, string phone_number) {
...
namespace Finance.Database1DataSet3TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([id] = @Original_id) AND ([name] = @Original_na" +
                ...
                "AND ([department] = @Original_department) AND ([phone_number] = @Original_phone_" +
                "number))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([name], [username], [password], [department], [phone_number]) VALUES (@name, @username, @password, @department, @phone_number);
SELECT id, name, username, password, department, phone_number FROM Users WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [name] = @name, [username] = @username, [password] = @password, [department] = @department, [phone_number] = @phone_number WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([department] = @Original_department) AND ([phone_number] = @Original_phone_number));
SELECT id, name, username, password, department, phone_number FROM Users WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, username, password, department, phone_number FROM dbo.Users";
        ...
        public virtual int Fill(Database1DataSet3.UsersDataTable dataTable) {
        ...
        public virtual Database1DataSet3.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.UsersDataTable dataTable = new Database1DataSet3.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_username, string Original_password, string Original_department, string Original_phone_number) {
        ...
        public virtual int Insert(string name, string username, string password, string department, string phone_number) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string username, string password, string department, string phone_number, int Original_id, string Original_name, string Original_username, string Original_password, string Original_department, string Original_phone_number, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string username, string password, string department, string phone_number, int Original_id, string Original_name, string Original_username, string Original_password, string Original_department, string Original_phone_number) {
            return this.Update(name, username, password, department, phone_number, Original_id, Original_name, Original_username, Original_password, Original_department, Original_phone_number, Original_id);
        }
    }
