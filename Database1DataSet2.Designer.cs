...
namespace Finance {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class BudgetDataTable : global::System.Data.TypedTableBase<BudgetRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BudgetRow AddBudgetRow(int id, string department, decimal amount) {
...
namespace Finance.Database1DataSet2TableAdapters {
    ...
    public partial class BudgetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Budget] ([id], [department], [amount]) VALUES (@id, @departmen" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Budget] SET [id] = @id, [department] = @department, [amount] = @amount WHERE (([id] = @Original_id) AND ((@IsNull_department = 1 AND [department] IS NULL) OR ([department] = @Original_department)) AND ((@IsNull_amount = 1 AND [amount] IS NULL) OR ([amount] = @Original_amount)));
SELECT id, department, amount FROM Budget WHERE (id = @id)";
        ...
        public virtual int Fill(Database1DataSet2.BudgetDataTable dataTable) {
        ...
        public virtual Database1DataSet2.BudgetDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet2.BudgetDataTable dataTable = new Database1DataSet2.BudgetDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet2.BudgetDataTable dataTable) {
        ...
        public virtual int Insert(int id, string department, global::System.Nullable<decimal> amount) {
        ...
        public virtual int Update(int id, string department, global::System.Nullable<decimal> amount, int Original_id, string Original_department, global::System.Nullable<decimal> Original_amount) {
        ...
        public virtual int Update(string department, global::System.Nullable<decimal> amount, int Original_id, string Original_department, global::System.Nullable<decimal> Original_amount) {
            return this.Update(Original_id, department, amount, Original_id, Original_department, Original_amount);
        }
    }
